...
static u32 registers[8] = {0, 0, 0, 0, 0, 0, 0, 0};
...
int main(void)
{
	...
	ASSERT(stat("listing_0046_add_sub_cmp", &disassembly_stat) == 0);

	unsigned long long disassembly_size = disassembly_stat.st_size;
	int disassembly_fd = open("listing_0046_add_sub_cmp", O_RDONLY);
